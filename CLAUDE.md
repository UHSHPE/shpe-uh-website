...
|--------|------|------|-------------|
| POST | `/login` | No | Returns JWT token (rate limited: 5/minute per IP); 403 if the account's email isn't verified |
