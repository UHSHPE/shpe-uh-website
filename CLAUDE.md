...
shpe-uh-website/
  frontend/
    src/
      ...
      pages/              # home, about, gallery, membershpe, sponsors, get-involved, dashboard, committees, profile, members, shop-manager, shop, shop-product, shop-checkout, shop-order
  ...
  backend/
    ...
    tests/                # pytest suite; conftest.py has in-memory-DB fixtures (client, session, user) + make_user/make_event helpers; shop_tests/conftest.py adds manager_client/make_product/sent_emails; admin_tests/conftest.py adds president_client/make_president/make_dues_order
