...
- Seeded admins: president **Daniel Lopez Gil** (`daniel.lopez.gil@`), VP External **Carlos Alba** (`carlos.alba@`), VP Internal **Gabriela Lorenzo** (`gabriela.lorenzo@`) — all `@cougarnet.uh.edu` / `password123`, names matching the About page E-Board.
